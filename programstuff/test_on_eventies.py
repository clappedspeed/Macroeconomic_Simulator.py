    ...
    def apply_event(self, economic_indicator):
        for outcome in self.outcomes:
            if outcome.effect_type == "GDP":
                economic_indicator.gdp *= (1 + outcome.magnitude)
            elif outcome.effect_type == "Inflation":
                economic_indicator.inflation *= (1 + outcome.magnitude)
            elif outcome.effect_type == "Unemployment":
                economic_indicator.unemployment *= (1 + outcome.magnitude)
            elif outcome.effect_type == "Balance of Payment":
                economic_indicator.balance_of_payment *= (1 + outcome.magnitude)
            elif outcome.effect_type == "Budget":
                economic_indicator.budget *= (1 + outcome.magnitude)
...
events_data = [
    ...
    },
    {
        ...
        "outcomes": [
            ...
            {"effect_type": "Unemployment", "description": "Shifts in employment due to automation", "magnitude": 0.3, "duration": 180},
    ...
    },
    {
        ...
        "outcomes": [
            ...
            {"effect_type": "Unemployment", "description": "Job creation and lower unemployment", "magnitude": -0.3, "duration": 365},
            {"effect_type": "Balance of Payment", "description": "Impact on trade due to increased exports", "magnitude": 0.04, "duration": 365},
    ...
    },
    {
        ...
        "outcomes": [
            ...
            {"effect_type": "Balance of Payment", "description": "Positive impact on trade balance", "magnitude": -0.03, "duration": 180},
    ...
    },
    {
        ...
        "outcomes": [
            ...
            {"effect_type": "Balance of Payment", "description": "Impact on international competitiveness", "magnitude": 0.02, "duration": 240},
            {"effect_type": "Budget", "description": "Government spending on climate initiatives", "magnitude": -0.03, "duration": 240},
        ],
        "impact": 0.04,
        "probability": 0.1,
    },
...
# making an EconomicIndicator instance
economic_indicator = EconomicIndicator(1000, 2, 5, 500, 300)
print("Initial Economic Indicators:")
print(economic_indicator)

event_name_to_test = "Tarrif Reductions"  # Change this to the desired event name

# Find the specified event
selected_event = None
for event in events:
    if event.name == event_name_to_test:
        selected_event = event
        break

# Check if the event was found
if selected_event:
    # Apply the selected event to the EconomicIndicator instance
    selected_event.apply_event(economic_indicator)
    print(f"\nEvent Applied: {selected_event.name}")
else:
    print(f"\nEvent '{event_name_to_test}' not found.")
